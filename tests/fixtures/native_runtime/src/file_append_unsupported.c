...
/* Deliberately requests append_existing_file behavior unsupported on native_alma.
   Symbols CreateFileW + WriteFile are supported; OPEN_EXISTING + FILE_APPEND_DATA is not. */
